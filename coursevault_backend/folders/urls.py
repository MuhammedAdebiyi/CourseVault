...
urlpatterns = [
    ...
    path('search-files/', views.search_files, name='search-files'),  
    path('recent-files/', views.recent_files, name='recent-files'),  
    path('search-pdf-content/', views.search_pdf_content, name='search-content'),
